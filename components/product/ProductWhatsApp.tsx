...
// "Order via WhatsApp" — captures hesitant cold-traffic buyers in CR who don't
// trust paying upfront online. Opens WhatsApp with the product pre-filled.
  ...
  return (
    <div className="pt-1">
      ...
      <p className="mt-2 text-center text-xs text-gray-500">
        ¿Preferís comprar con confianza? Escribinos y te atendemos al instante 💬
      </p>
    </div>
  );
}
